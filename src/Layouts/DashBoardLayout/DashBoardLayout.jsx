            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-[#0D2A38] text-white min-h-full w-80 p-8 space-y-4">
                    ...
                    <li>
                        ...
                        <li>
                            <Link to="/dashboard/make-admin" className="flex items-center gap-3 text-lg font-semibold hover:bg-white/10 rounded-xl py-3 px-5 transition-all active:scale-95">
