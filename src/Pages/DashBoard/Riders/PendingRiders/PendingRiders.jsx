...
const PendingRiders = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-3xl shadow-sm">
                            ...
                            <tr key={rider._id} className="hover:bg-gray-50">
                                ...
                                <td className="flex justify-center gap-2">
                                    ...
                                    <button 
                                        ...
                                        className="btn btn-square btn-sm bg-blue-100 text-blue-600 border-none hover:bg-blue-200"
                                    >
                                        <Eye size={18} />
                                    </button>
            ...
            {/* DaisyUI Modal for Details */}
            {selectedRider && (
                <div className="modal modal-open">
                    <div className="modal-box max-w-2xl bg-white border-4 border-[#D4E96D]">
                        ...
                        <div className="grid grid-cols-2 gap-6 mt-6">
                            <div>
                                <p className="text-xs text-gray-400 uppercase font-bold">NID Number</p>
                                <p className="text-lg font-semibold">{selectedRider.nid}</p>
                            </div>
                            <div>
                                <p className="text-xs text-gray-400 uppercase font-bold">License No</p>
                                <p className="text-lg font-semibold">{selectedRider.license}</p>
                            </div>
                            <div>
                                <p className="text-xs text-gray-400 uppercase font-bold">Phone</p>
                                <p className="text-lg font-semibold">{selectedRider.phone}</p>
                            </div>
                            <div>
                                <p className="text-xs text-gray-400 uppercase font-bold">Bike Reg</p>
                                <p className="text-lg font-semibold text-blue-600">{selectedRider.bikeReg}</p>
                            </div>
                        </div>
                        ...
                        <div className="modal-action">
                            <button onClick={() => setSelectedRider(null)} className="btn bg-[#0D2A38] text-white rounded-xl">Close</button>
                        </div>
                    </div>
                </div>
            )}
